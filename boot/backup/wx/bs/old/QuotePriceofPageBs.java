...
////		zbh.com.qqbx.aitp.aiws.xmlbeans.policyenddate.ReqVehicleInfo vehicleInfo = new zbh.com.qqbx.aitp.aiws.xmlbeans.policyenddate.ReqVehicleInfo();
...
////				setSearch(true);
//				//设置查询条件
//				addRule(v.getQuoteNo(), WhereRuleOper.zbh,rq.getQuoteNo());
//			}
//		});
