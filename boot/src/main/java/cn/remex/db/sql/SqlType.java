...
public class SqlType {
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Type>> TAllFields = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Type>> TBaseFields = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TBaseGetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TBaseSetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Type>> TCollectionFields = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TCollectionGetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TCollectionSetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Type>> TMapFields = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TMapGetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TMapSetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Type>> TObjectFields = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TObjectGetter = new ReadOnlyMap<>();
	final static private ReadOnlyMap<Class<?>, ReadOnlyMap<String,Method>> TObjectSetter = new ReadOnlyMap<>();
...
//			Type[] atas = ((ParameterizedTypeImpl)type).getActualTypeArguments();
	...
	public static boolean isTObject(final Type type){
		if(type instanceof Class<?> && ModelableImpl.class.isAssignableFrom(((Class) type))) {
			return true;
		}
		return false;
	}
