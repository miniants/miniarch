 ...
 * @TODO 描述
 */
public class RegisterIntegralSaver extends IntegralSaver {

	private static final long serialVersionUID = 7861250790844186926L;

	public void saveIntegral(Member me, Map<String,Object>params){
		
		AiwbConsts.IntegralWay way = AiwbConsts.IntegralWay.Register;
		...
		integralBeanDetail.setType(AiwbConsts.IntegralType.Bean);// 卡币
		...
		integralBeanDetail.setDesc("注册获取积分");
