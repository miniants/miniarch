...
public class MmbDeliveryBs  implements AiwbConsts{
	...
	public BsRvo execute(BsCvo bsCvo,BsRvo bsRvo){
		...
		List<anbox.aibc.appBeans.mmbCenter.DeliveryInfo> dis = new ArrayList<anbox.aibc.appBeans.mmbCenter.DeliveryInfo>();
		for(DeliveryInfo di:deliveryInfos){
			anbox.aibc.appBeans.mmbCenter.DeliveryInfo deliveryInfo = new anbox.aibc.appBeans.mmbCenter.DeliveryInfo();
