...
import cn.remex.cert.AuthenticateBean;
...
public class AuthenticateBtx {
	 ...
	 * @return true代表
	 * @throws Exception
	 * @rmx.call {@link cn.remex.RemexFilter# doFilter(ServletRequest sRequest, ServletResponse sResponse, FilterChain chain)}
	 */
...
//			}
	 ...
	 * @param needLogMsg
	 *          是否需要记录日志的标志
	 * @rmx.call {@link cn.remex.RemexFilter#init(FilterConfig filterConfig)}
	 */
