...
public class SqlBeanNamedParam implements DataCacheCloneable {
	...
	public SqlBeanNamedParam(final int index, final String name, final int type, final Object value) {
		super();
		this.index = index;
		this.name = name;
		this.type = type;
	...
	@Override
	public SqlBeanNamedParam clone() throws CloneNotSupportedException {
		SqlBeanNamedParam cloned = (SqlBeanNamedParam) super.clone();
	...
	public String toString() {
		...
		builder.append("\r\tSqlNamedParam [")
		.append("index=")
		.append(this.index)
		.append(", type=")
		.append(this.type)
