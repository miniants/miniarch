...
//	private static HashMap<String, String> config = new HashMap<String, String>();
	...
	public static String obtainConfig(String environment,String confClass,String confKind,String confType,String group,String key){
		SysConfig conf = ContainerFactory.getSession().queryBeanByJpk(SysConfig.class, null, "environment;confClass;confKind;confType;group;key", environment,confClass,confKind,confType,confType,key);
