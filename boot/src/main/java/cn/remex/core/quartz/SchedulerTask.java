...
public class SchedulerTask {
	...
	private String intervalType = "day"; //day/week/month/once。sec/min尚不稳定。
	 ...
	 *
	 * @param jobClassName
	 * @param intervalType 支持day/week/month/once。sec/min尚不稳定。
	 * @param startDate  
	 */
	 ...
	 * @see SchedulerTask#SchedulerTask(Class, String, String, String, Date)
	 */
	...
	public JobDetail obtainJobDetail(String group) {
		JobDetail detail = new JobDetail(jobName, group, jobClassName);
	...
	public SchedulerTask delayStart(int delaySecond) {
		this.startDate.setTime(new Date(new Date().getTime() + delaySecond*1000));
		return this;
	}
	//--------------------getter and setter---------------------------------//
