 ...
 */
public class SysElement extends ModelableImpl implements
        Comparable<SysElement>  {
    private SysView view;
    ...
    @Override
    public int compareTo(final SysElement o) {
    ...
    public SysView getView() {
        return view;
    }

    public void setView(SysView view) {
        this.view = view;
    }
}
