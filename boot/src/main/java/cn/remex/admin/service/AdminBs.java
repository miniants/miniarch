...
public class AdminBs {
	...
	public BsRvo execute(AdminBsCvo bsCvo) {
        ...
        //3
		System.out.print(bsCvo.$V("r1v"));
		return RemexAdminUtil.obtainAdminRvo(new AdminBsRvo(), "/admin/admin");
	}
	@BusinessService
	public BsRvo confSysMenu(AdminBsRvo bsCvo) {
		return RemexAdminUtil.obtainAdminRvo(new AdminBsRvo(), "/admin/admin");
	}
	@BusinessService
	...
	@BusinessService
	public BsRvo editUser(BsCvo bsCvo,BsRvo bsRvo) {
		String id = bsCvo.getPk();
		
		bsRvo = RemexAdminUtil.obtainAdminRvo(new AdminBsRvo(),"/admin/editUser");
...
//		RemexAdminUtil.saveDataMeta(bsRvo, dbRvo);
	...
	public BsRvo listLogonLogMsg(AdminBsCvo bsCvo) {
		...
		BsRvo bsRvo = RemexAdminUtil.obtainAdminRvo(new AdminBsRvo(), "/admin/listLogonLogMsg");
