...
@Table(uniqueConstraints={
		@UniqueConstraint(columnNames = {"openId","licenseNo","frameNo","engineNo"}
				)
})
public class CustomerVehicle  extends CommModel{
	private static final long serialVersionUID = 5018285616559715544L;  
	...
	@SqlTypeAnnotation(type=Types.CHAR, length = 50, sqlType = " ")
	private String tciStartDate;   //商业险起期
	@SqlTypeAnnotation(type=Types.CHAR, length = 50, sqlType = " ")
	private String vciStartDate;   //交强险起期
	@SqlTypeAnnotation(type=Types.CHAR, length = 50, sqlType = " ")
	private String tciEndDate;   //商业险止期
	@SqlTypeAnnotation(type=Types.CHAR, length = 50, sqlType = " ")
	private String vciEndDate;   //交强险止期
