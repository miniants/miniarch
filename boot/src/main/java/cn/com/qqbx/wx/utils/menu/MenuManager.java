package cn.com.qqbx.wx.utils.menu;
...
public class MenuManager {  
    ...
    private static Menu getMenu() {  
        ...
        btn11.setName("安卡比价");  
//        btn11.setKey("11");  
        btn11.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx16f616bf5fa97471&redirect_uri=http://www.qqbx.com.cn/WxSys/wx/page/cf_atin.html&response_type=code&scope=snsapi_base&state=2#wechat_redirect");
...
//        btn21.setUrl("http://mp.weixin.qq.com/s?__biz=MzA3MTc0NDIxOA==&mid=202511725&idx=1&sn=a9aa3fdd54aac2d3704644180e1b4352&scene=1&from=groupmessage&isappinstalled=0#rd");
        ...
        btn21.setName("理赔服务");  
        btn21.setType("view");  
        btn21.setUrl("http://www.qqbx.com.cn/WxSys/wx/page/yh_claimGuide.html");
        //btn22.setKey("22");  
//        btn22.setUrl("http://www.qqbx.com.cn/wx/wx/page/carinfo.html");
        ...
        btn22.setType("view");  
       // btn23.setKey("23");  
        btn22.setUrl("http://www.qqbx.com.cn/WxSys/wx/page/yh_operateGuide.html");
        CommonButton btn23 = new CommonButton();  
        btn23.setName("关于安卡");  
        btn23.setType("view");  
        // btn23.setKey("23");  
        btn23.setUrl("http://www.qqbx.com.cn/WxSys/wx/page/yh_aboutAncar.html");
      ...
      CommonButton btn31 = new CommonButton();  
    	 ...
    	 btn31.setName("会员中心");  
//      btn11.setKey("11");  
    	 btn31.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx16f616bf5fa97471&redirect_uri=http://www.qqbx.com.cn/WxSys/wx/page/mm_member.html&response_type=code&scope=snsapi_base&state=2#wechat_redirect");
