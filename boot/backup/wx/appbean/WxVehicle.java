...
public class WxVehicle implements Serializable{
	private String isOneCar;
	private String pack;
	...
	private String tciStartDate;   //商业险上年保险止期
	private String vciStartDate;   //商业险上年保险止期
	...
	public String getIsOneCar() {
		return isOneCar;
	}
	public void setIsOneCar(String isOneCar) {
		this.isOneCar = isOneCar;
	}
