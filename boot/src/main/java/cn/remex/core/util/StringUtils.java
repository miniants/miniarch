...
public abstract class StringUtils {
	 ...
	 * index 1 being after the delimiter (neither element includes the delimite
	 ...
	 * @param index the index in the original string to start matching against 起始位置
	 * @param substring the substring to match at the given index 子字符序列
	 */
