 ...
 */
public class RemexApplication implements ApplicationContextAware, ApplicationEventPublisherAware, RemexConstants {
	/**
	 ...
	 * 调用RsqlDao的数据连接事务管理。{@link RsqlTransactionalManager}
	 * 
	 * TODO 后续补充相关内容。
	 * 
	 * @param <T>
