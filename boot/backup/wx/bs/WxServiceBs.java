...
import zbh.wx.utils.WxCheckUtil;
...
import zbh.remex.fsm.FsmConfiguration;
import zbh.remex.fsm.FsmController;
...
import zbh.remex.sam.model.SamMessage;
...
//		String content = reqBaseMessage.getContent();
		...
		if(("event".equals(msgType) && "subscribe".equals(event))||"text".equalsIgnoreCase(msgType)){
			 ...
			 String content = "亲，\n我姗姗来迟，但是绝对新鲜。盟友众多、实时比价、在线出单，为广大车主及代理人服务。这就是我，安卡车险！" +
			 		"<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx16f616bf5fa97471&redirect_uri=http://www.qqbx.com.zbh/WxSys/wx/page/cf_atin.html&response_type=code&scope=snsapi_base&state=2#wechat_redirect'>点击进入安卡比价</a>";
...
//		}
	...
	public static void main(String... args) throws UnsupportedEncodingException {
		...
		fsmActionPackages.add("zbh.com.qqbx.wx.fsmaction");
